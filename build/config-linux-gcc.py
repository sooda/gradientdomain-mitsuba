...
CXX            = 'g++'
CC             = 'gcc'
CXXFLAGS       = ['-O3', '-Wall', '-g', '-pipe', '-march=nocona', '-msse2', '-ftree-vectorize', '-mfpmath=sse', '-funsafe-math-optimizations', '-fno-rounding-math', '-fno-signaling-nans', '-fno-math-errno', '-fomit-frame-pointer', '-DMTS_DEBUG', '-DDOUBLE_PRECISION', '-DSPECTRUM_SAMPLES=3', '-fopenmp', '-fvisibility=hidden', '-mtls-dialect=gnu2', '-std=c++11']
LINKFLAGS      = []
